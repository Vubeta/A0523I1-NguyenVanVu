...
-- step 1: list khach_hang da dat hop dong trong nam 2021 (1 khách hàng có thê có nhiêu hop đông ==> khách hàng có thê trùng lăp)
...
-- step 2: list khach_hang có ten_loai_khach tu step 1 là Platinum có Tông Tiên thanh toán là lon hon 10.000.000 VNĐ. (gôp các khách hàng đang trùng lăp)
