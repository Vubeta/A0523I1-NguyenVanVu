...
-- Task 8. Hiên thi thông tin ho_ten khách hàng có trong hê thông, voi yêu câu ho_ten không trùng nhau.
-- Hoc viên su dung theo 3 cách khác nhau đê thuc hiên yêu câu trên.
-- Cach 1:
select distinct khhoten as ho_ten
from khach_hang;
-- Cach 2:
select max(khhoten) as ho_ten
from khach_hang
group by khhoten;
-- Cach 3:
select min(khhoten) as ho_ten
from khach_hang
group by khhoten;