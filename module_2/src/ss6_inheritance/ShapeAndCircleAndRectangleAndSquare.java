...
public class ShapeAndCircleAndRectangleAndSquare {
    public static void main(String[] args) {
        //test Shape
        NewShape shape = new NewShape();
        System.out.println(shape);

        shape = new NewShape("red", false);
        System.out.println(shape);
        ...
        circle = new NewCircle(3.5);
        System.out.println(circle);

        circle = new NewCircle(3.5, "indigo", false);
        System.out.println(circle);
...
class NewShape {
    ...
    public NewShape(String color, boolean filled) {
        this.color = color;
        this.filled = filled;
    }
